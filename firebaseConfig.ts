...
  databaseURL: "https://pawfeeds-v2-default-rtdb.asia-southeast1.firebasedabase.app"
};
...
const database = getDatabase(app); // This is your Realtime Database instance

// Export all the configured services
// UPDATE: Export 'database' as 'rtdb' to match your other files
export { auth, db, database as rtdb };
